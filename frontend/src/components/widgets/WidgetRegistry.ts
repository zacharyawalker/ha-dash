...
export const widgetDefinitions: WidgetDefinition[] = [
  ...
  // === Irrigation Zone ===
  {
    ...
    configFields: [
      ...
      { key: 'timerEntityId', label: 'Timer Entity', type: 'entity', domain: 'timer' },
  ...
  // === Irrigation Panel ===
  {
    ...
    minWidth: 350,
    minHeight: 300,
    defaultConfig: { label: 'Irrigation Control' },
    configFields: [
      { key: 'label', label: 'Title', type: 'text' },
      ...
      { key: 'dailyRuntimeId', label: 'Daily Runtime Sensor', type: 'entity', domain: 'sensor' },
      { key: 'nextRunId', label: 'Next Run Sensor', type: 'entity', domain: 'sensor' },
    ],
  },
  ...
  // === Irrigation Schedule ===
  {
    ...
    minWidth: 240,
    minHeight: 300,
    defaultConfig: { label: 'Irrigation Schedule' },
    configFields: [
      { key: 'entityId', label: 'Schedule Toggle', type: 'entity', domains: ['automation', 'input_boolean'], required: true },
      { key: 'runningEntityId', label: 'Running Indicator', type: 'entity', domain: 'input_boolean' },
      { key: 'scheduleSelectId', label: 'Program Selector', type: 'entity', domain: 'input_select' },
      { key: 'runAutomationId', label: 'Run Automation', type: 'entity', domain: 'automation' },
      { key: 'rainDelayEntityId', label: 'Rain Delay', type: 'entity', domains: ['number', 'input_number'] },
      { key: 'nextRunEntityId', label: 'Next Run', type: 'entity', domain: 'sensor' },
      { key: 'lastRunEntityId', label: 'Last Run', type: 'entity', domains: ['input_text', 'sensor'] },
